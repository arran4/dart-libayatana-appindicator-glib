...
class DBusMenuStrategy implements IndicatorStrategy {
  final String id;
  ...
  Future<void> connect({String? watcherName, String? watcherPath}) async {
    ...
    stderr.writeln('[debug] DBusMenuStrategy.connect: '
  ...
  // Event setters (Ignored for DBusMenu as it only handles menu events internally?)
  // Wait, DBusMenu has "Event" method.
  // But AppIndicator events (scroll, secondary activate) are on the SNI object.
  // So DBusMenuStrategy ignores them.
  @override
