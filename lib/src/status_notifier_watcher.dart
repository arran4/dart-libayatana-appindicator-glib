...
class StatusNotifierWatcherStatusNotifierItemRegistered extends DBusSignal {
  ...
  StatusNotifierWatcherStatusNotifierItemRegistered(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class StatusNotifierWatcherStatusNotifierItemUnregistered extends DBusSignal {
  ...
  StatusNotifierWatcherStatusNotifierItemUnregistered(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class StatusNotifierWatcherStatusNotifierHostRegistered extends DBusSignal {
  StatusNotifierWatcherStatusNotifierHostRegistered(DBusSignal signal) : super(sender: signal.sender, path: signal.path, interface: signal.interface, name: signal.name, values: signal.values);
}
...
class StatusNotifierWatcher extends DBusRemoteObject {
  ...
  late final Stream<StatusNotifierWatcherStatusNotifierItemRegistered> statusNotifierItemRegistered;

  /// Stream of org.kde.StatusNotifierWatcher.StatusNotifierItemUnregistered signals.
  late final Stream<StatusNotifierWatcherStatusNotifierItemUnregistered> statusNotifierItemUnregistered;

  /// Stream of org.kde.StatusNotifierWatcher.StatusNotifierHostRegistered signals.
  late final Stream<StatusNotifierWatcherStatusNotifierHostRegistered> statusNotifierHostRegistered;

  StatusNotifierWatcher(DBusClient client, String destination, {DBusObjectPath path = const DBusObjectPath.unchecked('/StatusNotifierWatcher')}) : super(client, name: destination, path: path) {
    statusNotifierItemRegistered = DBusRemoteObjectSignalStream(object: this, interface: 'org.kde.StatusNotifierWatcher', name: 'StatusNotifierItemRegistered', signature: DBusSignature('s')).asBroadcastStream().map((signal) => StatusNotifierWatcherStatusNotifierItemRegistered(signal));

    statusNotifierItemUnregistered = DBusRemoteObjectSignalStream(object: this, interface: 'org.kde.StatusNotifierWatcher', name: 'StatusNotifierItemUnregistered', signature: DBusSignature('s')).asBroadcastStream().map((signal) => StatusNotifierWatcherStatusNotifierItemUnregistered(signal));

    statusNotifierHostRegistered = DBusRemoteObjectSignalStream(object: this, interface: 'org.kde.StatusNotifierWatcher', name: 'StatusNotifierHostRegistered', signature: DBusSignature('')).asBroadcastStream().map((signal) => StatusNotifierWatcherStatusNotifierHostRegistered(signal));
  }
