...
void main() {
  test('AppIndicator splits icon path into name and theme path', () async {
    ...
    expect(indicator.iconName, equals(iconFile.path), reason: 'IconName getter should return the full path set by user');

    // Verify that the computed theme path is correct
    expect(indicator.iconThemePath, equals(tempDir.path), reason: 'IconThemePath should be the directory of the icon file');
